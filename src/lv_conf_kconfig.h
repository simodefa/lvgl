...
#elif defined(CONFIG_LV_SDL_RENDER_MODE_PARTIAL_BATCH)
#  define CONFIG_LV_SDL_RENDER_MODE LV_DISPLAY_RENDER_MODE_PARTIAL_BATCH
...
#elif defined(CONFIG_LV_LINUX_FBDEV_RENDER_MODE_PARTIAL_BATCH)
#  define CONFIG_LV_LINUX_FBDEV_RENDER_MODE LV_DISPLAY_RENDER_MODE_PARTIAL_BATCH
